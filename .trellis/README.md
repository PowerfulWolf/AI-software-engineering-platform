...
- 当前手册按 [docs 分类索引](../docs/README.md) 导航；历史快照按 archive 索引查阅。
- 工程任务目录使用 [任务索引](tasks/README.md) 区分待办、待核实和完成记录。
- 文档迁移保存旧路径、来源 revision 和 SHA-256；独立报告原文保持不变，另建路径映射。
- 已合入的工程任务补完成状态和确切提交；缺失证据保留为待核实，不能补造验收结论。
