"""Read-only stage advancement guards for the Manager Agent.

The Manager may authorize the next role only after validating the exact immutable
...
class ProjectStage(StrEnum):
    """Role boundary that the Manager can authorize."""
...
class ProjectStageError(RuntimeError):
    """Base error for Manager stage authorization."""
