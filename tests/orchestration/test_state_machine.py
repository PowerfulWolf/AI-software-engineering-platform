...
@pytest.mark.parametrize(
    ...
    (
        ...
        (TaskStatus.IMPLEMENTING, TaskStatus.CONTINUE_REQUIRED),
        (TaskStatus.CONTINUE_REQUIRED, TaskStatus.QUEUED),
        (TaskStatus.QUEUED, TaskStatus.IMPLEMENTING),
        ...
        (TaskStatus.CONTINUE_REQUIRED, TaskStatus.BLOCKED),
        (TaskStatus.CONTINUE_REQUIRED, TaskStatus.FAILED),
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (TaskStatus.CONTINUE_REQUIRED, TaskStatus.QA),
        (TaskStatus.QUEUED, TaskStatus.QA),
